...
- [ ] **Budget Management**
  ...
  - Warning ketika mendekati limit
  - Progress bar budget
...
- [ ] **Multi-Currency Support**
  - Support multiple currency (IDR, USD, EUR, etc)
  - Currency converter dengan real-time rates
  - Display in preferred currency

- [ ] **Notifikasi & Alert**
  - Email notification untuk milestone
  - Push notification untuk budget warning
  - Daily/Weekly summary email

- [ ] **Collaboration** (untuk family/group)
  - Share expense dengan family members
  - Split bills functionality
  - Shared budget tracking

- [ ] **Advanced Search & Filter**
  - Search transaksi by keywords
  - Advanced filter (date range, amount range, category)
  - Save filter presets
...
- [ ] **Audit Trail & History**
  ...
  - Version history untuk transaksi
