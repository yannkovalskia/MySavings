...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_password'])) {
    ...
    if (empty($old_password) || empty($new_password) || empty($confirm_password)) {
        ...
        // Update password
        $query_pwd = "UPDATE users SET password = ? WHERE id = ?";
        $stmt_pwd = $koneksi->prepare($query_pwd);
...
<head>
    ...
    <title>Settings - MySavings</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <!-- Tabs -->
            <div class="tabs">
                <button class="tab-btn active" onclick="switchTab('profil')">Edit Profil</button>
                <button class="tab-btn" onclick="switchTab('password')">Ubah Password</button>
            </div>
            ...
            <div id="profil" class="tab-content active">
                ...
                <?php if (!empty($success) && isset($_POST['update_profil'])): ?>
                ...
                <div class="settings-card">
                    ...
                    <form method="POST" action="">
                        <div class="form-group">
                            ...
                            <input type="password" id="old_password" name="old_password" placeholder="Masukkan password lama Anda" required>
                        </div>

                        <div class="form-group">
                            <label for="new_password">Password Baru</label>
                            <input type="password" id="new_password" name="new_password" placeholder="Masukkan password baru (minimal 6 karakter)" required>
                        </div>
